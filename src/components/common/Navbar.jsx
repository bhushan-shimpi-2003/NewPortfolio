    ...
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-3 sm:px-6 lg:px-8 py-3">
      <div className={`max-w-7xl mx-auto rounded-2xl transition-all duration-300 glass-card hologram-border ${
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-indigo-600 to-cyan-500 flex items-center justify-center text-white font-display font-black text-sm shadow-md group-hover:scale-105 transition-transform duration-300">
              BS
            </div>
          ...
          {/* Desktop Nav Items */}
          <nav className="hidden md:flex items-center gap-1 bg-slate-100/60 dark:bg-slate-900/60 p-1.5 rounded-xl border border-slate-200/60 dark:border-white/10 backdrop-blur-xl">
            {navLinks.map((link) => (
              <NavLink
                key={link.path}
                to={link.path}
          ...
          <div className="flex items-center gap-2.5">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hidden sm:inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs shadow-md shadow-emerald-500/20 hover:scale-105 active:scale-95 transition-all"
            >
            ...
            <Link
              to="/contact"
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs shadow-md shadow-indigo-500/20 hover:scale-105 active:scale-95 transition-all"
            >
