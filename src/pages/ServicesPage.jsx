...
import { Globe, Smartphone, Sparkles, ShieldCheck, CheckCircle2, HelpCircle } from 'lucide-react';
...
export default function ServicesPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 md:pt-28 pb-20 space-y-20">
      ...
      <section className="text-center max-w-3xl mx-auto space-y-4">
        ...
        <h1 className="font-display font-extrabold text-3xl sm:text-4xl md:text-5xl text-slate-900 dark:text-white tracking-tight">
          Freelance Services & <span className="text-gradient">Pricing Tiers</span>
        </h1>
        <p className="text-xs sm:text-sm md:text-base text-slate-600 dark:text-slate-400">
          Transparent, milestone-based software engineering for startups and scaling businesses. No hidden retainers, 100% intellectual property ownership.
        </p>
      </section>
        ...
        {freelanceServices.map((svc) => {
          ...
          return (
            <div
              ...
              className="rounded-3xl glass-card p-6 sm:p-8 flex flex-col justify-between hover:border-brand-500 transition-all duration-300 group"
            >
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <div className="font-display font-bold text-base text-slate-900 dark:text-white">{svc.startingRate}</div>
                  </div>
                </div>

                <div>
                  <h3 className="font-display font-bold text-xl text-slate-900 dark:text-white group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors">
                    {svc.title}
                  </h3>
                ...
                <div className="space-y-2.5">
                  <p className="text-[11px] font-mono font-bold uppercase text-slate-400">What is included</p>
                ...
                <div className="p-4 rounded-2xl bg-slate-100/70 dark:bg-slate-800/60 text-xs text-slate-600 dark:text-slate-300 space-y-1">
              ...
              <div className="pt-6 mt-6 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
                <span className="text-xs font-mono text-slate-500">
                  Estimated Timeline: {svc.deliveryTime}
                </span>
                <a
                  href="#estimator"
                  onClick={playClick}
                  className="px-4 py-2 rounded-xl bg-brand-500/10 hover:bg-brand-500 hover:text-white text-brand-600 dark:text-brand-400 font-bold text-xs transition-all"
                >
                  Estimate Now
                </a>
              </div>
